...
INSERT INTO MICRO_OVEN VALUES(3, 'Brand3', 'Model3', 30.0, 1800, 'Stainless Steel', FALSE, TRUE, TRUE, FALSE, 299.99, 2, '50x40x40 cm', '{"Bake", "Keep Warm", "Pizza Mode"}', 'Modern look');
INSERT INTO MICRO_OVEN VALUES(4, 'Brand4', 'Model4', 35.0, 2000, 'Silver', TRUE, FALSE, FALSE, TRUE, 349.99, 3, '55x45x45 cm', '{"Defrost", "Dehydrate", "Steam Clean"}', 'High capacity');
INSERT INTO MICRO_OVEN VALUES(5, 'Brand5', 'Model5', 40.0, 2200, 'Red', FALSE, TRUE, TRUE, TRUE, 399.99, 2, '60x50x50 cm', '{"Convection", "Smart Controls", "Temperature Probe"}', 'Energy efficient');
INSERT INTO MICRO_OVEN VALUES(6, 'Brand6', 'Model6', 22.0, 1300, 'Black', TRUE, FALSE, TRUE, TRUE, 219.99, 2, '42x32x32 cm', '{"Rotating Tray", "Auto Cook", "Quick Defrost"}', 'Easy to use');
INSERT INTO MICRO_OVEN VALUES(7, 'Brand7', 'Model7', 28.0, 1600, 'White', FALSE, TRUE, TRUE, TRUE, 269.99, 3, '47x37x37 cm', '{"Multi-stage Cooking", "Sensor Reheat", "Turntable"}', 'Versatile features');
INSERT INTO MICRO_OVEN VALUES(8, 'Brand8', 'Model8', 32.0, 1900, 'Silver', TRUE, FALSE, FALSE, TRUE, 319.99, 2, '52x42x42 cm', '{"Crisp Function", "Even Heat", "Auto Menu"}', 'Durable construction');
INSERT INTO MICRO_OVEN VALUES(9, 'Brand9', 'Model9', 38.0, 2100, 'Black', FALSE, TRUE, TRUE, FALSE, 369.99, 3, '57x47x47 cm', '{"Slow Cook", "Thaw Function", "Memory Function"}', 'Modern design');
INSERT INTO MICRO_OVEN VALUES(10, 'Brand10', 'Model10', 45.0, 2400, 'White', TRUE, FALSE, TRUE, TRUE, 419.99, 2, '62x52x52 cm', '{"Browning Function", "Preheat", "Sabbath Mode"}', 'Large cooking space');
INSERT INTO MICRO_OVEN VALUES(11, 'Brand11', 'Model11', 26.0, 1400, 'Stainless Steel', FALSE, TRUE, TRUE, TRUE, 229.99, 3, '45x35x35 cm', '{"Defrost", "Keep Warm", "Auto Clean"}', 'Sleek appearance');
INSERT INTO MICRO_OVEN VALUES(12, 'Brand12', 'Model12', 34.0, 1700, 'Black', TRUE, FALSE, FALSE, TRUE, 299.99, 2, '55x45x45 cm', '{"Rotisserie", "Express Cooking", "Touch Controls"}', 'Efficient heating');
...
CREATE TABLE POWER_BANK (
    ...
    input_current DECIMAL(5,2),
    is_fast_charge BOOLEAN,
    is_wireless_charge BOOLEAN,
    is_pd_charge BOOLEAN,
    is_qc_charge BOOLEAN,
    price DECIMAL(10,2),
    warranty_period_months INT,
    dimensions VARCHAR(50),
...
SHOW TABLES;
INSERT INTO POWER_BANK  VALUES (1, 'Brand1', 'Model1', 10000, 5.0, 2.1, 5.0, 2.0, TRUE, FALSE, TRUE, FALSE, 29.99, 12, '100x60x20 mm', 'Slim design');
INSERT INTO POWER_BANK  VALUES (2, 'Brand2', 'Model2', 20000, 5.0, 2.4, 5.0, 2.5, TRUE, TRUE, TRUE, TRUE, 39.99, 18, '120x70x25 mm', 'High capacity');
INSERT INTO POWER_BANK  VALUES (3, 'Brand3', 'Model3', 15000, 5.0, 2.0, 5.0, 1.8, TRUE, FALSE, FALSE, TRUE, 34.99, 24, '110x65x22 mm', 'Lightweight and portable');
INSERT INTO POWER_BANK  VALUES (4, 'Brand4', 'Model4', 12000, 5.0, 2.0, 5.0, 1.5, FALSE, TRUE, TRUE, FALSE, 24.99, 12, '95x55x18 mm', 'Compact size');
INSERT INTO POWER_BANK  VALUES (5, 'Brand5', 'Model5', 18000, 5.0, 2.1, 5.0, 2.0, TRUE, TRUE, FALSE, TRUE, 44.99, 24, '130x70x22 mm', 'Durable construction');
INSERT INTO POWER_BANK  VALUES (6, 'Brand6', 'Model6', 25000, 5.0, 2.4, 5.0, 2.5, TRUE, FALSE, TRUE, TRUE, 49.99, 12, '140x75x30 mm', 'Rapid charging');
INSERT INTO POWER_BANK  VALUES (7, 'Brand7', 'Model7', 30000, 5.0, 2.1, 5.0, 2.0, TRUE, TRUE, TRUE, FALSE, 59.99, 18, '150x80x35 mm', 'Heavy-duty build');
INSERT INTO POWER_BANK  VALUES (8, 'Brand8', 'Model8', 20000, 5.0, 2.0, 5.0, 1.8, TRUE, FALSE, FALSE, TRUE, 39.99, 24, '120x65x25 mm', 'Sleek and stylish');
INSERT INTO POWER_BANK  VALUES (9, 'Brand9', 'Model9', 22000, 5.0, 2.1, 5.0, 2.0, TRUE, TRUE, TRUE, TRUE, 45.99, 12, '125x70x28 mm', 'Advanced features');
INSERT INTO POWER_BANK  VALUES (10, 'Brand10', 'Model10', 18000, 5.0, 2.4, 5.0, 2.5, TRUE, FALSE, TRUE, FALSE, 36.99, 18, '115x60x20 mm', 'Portable and efficient');
INSERT INTO POWER_BANK  VALUES (10, 'Brand10', 'Model10', 18000, 5.0, 2.4, 5.0, 2.5, TRUE, FALSE, TRUE, FALSE, 36.99, 18, '115x60x20 mm', 'Portable and efficient');
INSERT INTO POWER_BANK  VALUES(11, 'Brand11', 'Model11', 22000, 5.0, 2.3, 5.0, 2.2, TRUE, TRUE, FALSE, FALSE, 49.99, 24, '130x70x25 mm', 'Slim and sleek design');
INSERT INTO POWER_BANK  VALUES(12, 'Brand12', 'Model12', 25000, 5.0, 2.5, 5.0, 2.4, TRUE, FALSE, TRUE, TRUE, 59.99, 24, '140x75x30 mm', 'Fast charging capability');
...
SHOW TABLES;
INSERT INTO HARD_DISK VALUES (1, 'Brand1', 'Model1', 500, 'SATA', 7200, '3.5"', 64, FALSE, FALSE, TRUE, 49.99, 24, '100x70x10 mm', 'Includes backup software');
INSERT INTO HARD_DISK VALUES (2, 'Brand2', 'Model2', 1000, 'USB 3.0', NULL, '2.5"', 128, TRUE, TRUE, TRUE, 79.99, 12, '120x80x15 mm', 'Slim and portable design');
INSERT INTO HARD_DISK VALUES (3, 'Brand3', 'Model3', 2000, 'SATA', 5400, '2.5"', 256, TRUE, TRUE, TRUE, 119.99, 36, '130x85x20 mm', 'High-speed data transfer');
INSERT INTO HARD_DISK VALUES (4, 'Brand4', 'Model4', 500, 'USB 2.0', NULL, '3.5"', 32, FALSE, FALSE, TRUE, 39.99, 12, '105x75x12 mm', 'Affordable storage solution');
INSERT INTO HARD_DISK VALUES (5, 'Brand5', 'Model5', 4000, 'Thunderbolt 3', 7200, '3.5"', 512, TRUE, FALSE, TRUE, 199.99, 24, '150x100x25 mm', 'Professional-grade performance');
INSERT INTO HARD_DISK VALUES(6, 'Brand6', 'Model6', 2000, 'USB 3.1', 5400, '2.5"', 256, TRUE, TRUE, TRUE, 129.99, 36, '130x85x20 mm', 'High-speed data transfer');
INSERT INTO HARD_DISK VALUES(7, 'Brand7', 'Model7', 1000, 'USB-C', NULL, '2.5"', 128, TRUE, TRUE, TRUE, 89.99, 24, '120x80x15 mm', 'Compact and portable design');
INSERT INTO HARD_DISK VALUES(8, 'Brand8', 'Model8', 8000, 'SATA', 7200, '3.5"', 1024, TRUE, FALSE, TRUE, 299.99, 36, '200x150x30 mm', 'Massive storage capacity');
INSERT INTO HARD_DISK VALUES(9, 'Brand9', 'Model9', 3000, 'USB 3.0', 5400, '2.5"', 256, TRUE, TRUE, TRUE, 149.99, 24, '140x90x25 mm', 'Reliable backup solution');
INSERT INTO HARD_DISK VALUES(10, 'Brand10', 'Model10', 4000, 'Thunderbolt 3', 7200, '3.5"', 512, TRUE, FALSE, TRUE, 249.99, 36, '150x100x25 mm', 'Professional-grade performance');
INSERT INTO HARD_DISK VALUES(11, 'Brand11', 'Model11', 500, 'USB 2.0', NULL, '3.5"', 32, FALSE, FALSE, TRUE, 59.99, 12, '105x75x12 mm', 'Affordable storage solution');
INSERT INTO HARD_DISK VALUES(12, 'Brand12', 'Model12', 1000, 'SATA', 7200, '3.5"', 64, FALSE, FALSE, TRUE, 79.99, 24, '100x70x10 mm', 'Includes backup software');
...
CREATE TABLE BLOODBANK (
    ...
    expiry_date DATE,
    additional_info VARCHAR(60)
);
SHOW TABLES;
INSERT INTO BLOODBANK VALUES (1, 'John Doe', 30, 'A+', '2024-04-16', '09:30:00', 450.25, 'City Hospital', 1234567890, 'john.doe@example.com', TRUE, TRUE, 4.5, '2024-05-01', 'Healthy donor');
INSERT INTO BLOODBANK VALUES (2, 'Jane Smith', 25, 'B-', '2024-04-16', '10:45:00', 350.75, 'Community Center', 9876543210, 'jane.smith@example.com', FALSE, TRUE, 5.0, '2024-04-30', 'Regular donor');
INSERT INTO BLOODBANK VALUES (3, 'Michael Johnson', 35, 'O+', '2024-04-15', '11:00:00', 500.50, 'Red Cross Society', 1357924680, 'michael.johnson@example.com', TRUE, TRUE, 4.8, '2024-05-02', 'First-time donor');
INSERT INTO BLOODBANK VALUES (4, 'Emily Brown', 28, 'AB-', '2024-04-15', '12:15:00', 600.00, 'Blood Bank Center', 2468013579, 'emily.brown@example.com', TRUE, TRUE, 4.7, '2024-05-03', 'Regular donor');
INSERT INTO BLOODBANK VALUES (5, 'David Wilson', 45, 'O-', '2024-04-14', '13:30:00', 400.25, 'Local Clinic', 7894561230, 'david.wilson@example.com', FALSE, TRUE, 4.9, '2024-05-04', 'Healthy donor');
INSERT INTO BLOODBANK VALUES (6, 'Emma Martinez', 32, 'A-', '2024-04-14', '14:45:00', 550.75, 'Community Hospital', 3698521470, 'emma.martinez@example.com', TRUE, TRUE, 5.2, '2024-05-05', 'Regular donor');
INSERT INTO BLOODBANK VALUES (7, 'Christopher Taylor', 40, 'B+', '2024-04-13', '15:00:00', 480.50, 'Blood Donation Camp', 2589631470, 'christopher.taylor@example.com', TRUE, TRUE, 4.6, '2024-05-06', 'First-time donor');
INSERT INTO BLOODBANK VALUES (8, 'Olivia Garcia', 22, 'AB+', '2024-04-13', '16:15:00', 520.00, 'City Blood Bank', 1472583690, 'olivia.garcia@example.com', FALSE, TRUE, 5.1, '2024-05-07', 'Regular donor');
INSERT INTO BLOODBANK VALUES (9, 'Daniel Rodriguez', 38, 'O-', '2024-04-12', '17:30:00', 430.25, 'Regional Hospital', 6325419870, 'daniel.rodriguez@example.com', TRUE, TRUE, 4.7, '2024-05-08', 'Healthy donor');
INSERT INTO BLOODBANK VALUES (10, 'Sophia Hernandez', 29, 'A+', '2024-04-12', '18:45:00', 580.75, 'Blood Drive Event', 9517538640, 'sophia.hernandez@example.com', TRUE, TRUE, 5.0, '2024-05-09', 'Regular donor');
INSERT INTO BLOODBANK VALUES (11, 'Alexander Martinez', 33, 'B-', '2024-04-11', '19:00:00', 460.50, 'Community Blood Bank', 3691472580, 'alexander.martinez@example.com', FALSE, TRUE, 4.8, '2024-05-10', 'First-time donor');
INSERT INTO BLOODBANK VALUES (12, 'Mia Lopez', 26, 'AB+', '2024-04-11', '20:15:00', 530.00, 'Mobile Blood Donation Unit', 1479638520, 'mia.lopez@example.com', TRUE, TRUE, 4.9, '2024-05-11', 'Regular donor');
